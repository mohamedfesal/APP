...
class Users(UserMixin, db.Model):
    ...
    access_list = db.Column(db.String(100))
...
# # Define the User Access List model
# class Access_contrl(db.Model):
#     id = db.Column(db.Integer(), primary_key=True)
#     name = db.Column(db.String(50), unique=True)
#     user_access_ctr = db.relationship('User_access', backref= 'user_access_roles')
# # Define the UserAccess model
# class User_access(db.Model):
#     id = db.Column(db.Integer(), primary_key=True)
#     user_access_id = db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
#     access_id = db.Column(db.Integer(), db.ForeignKey('access_contrl.id', ondelete='CASCADE'))
...
# WFH PCs Table Model
#=========================
class Pcs_categ(db.Model):
    id = db.Column(db.Integer, primary_key = True, autoincrement = True)
    name = db.Column(db.String(250))
    pcs = db.relationship('pcs', backref= 'pcs_view')
#=========================
# PCs Details Model
#=========================
class pcs(db.Model):
    ...
    pcs_category = db.Column(db.Integer, db.ForeignKey('pcs_categ.id'))
#=========================
# WFH PCs Table Model
#=========================
...
class Stock(db.Model):
    ...
    stock_order= db.Column(db.Integer, db.ForeignKey('orders.id'))
    order_history = db.Column(db.Integer, db.ForeignKey('orders_history.id'))
...
class Orders(db.Model):
    ...
    items = db.relationship('Stock', backref='view_items')
#=====================================
# Delivery Orders Model
#=====================================
class Orders_history(db.Model):
    id = db.Column(db.Integer, primary_key = True)
    item = db.relationship('Stock', backref='items_hist')
    date = db.Column(db.DateTime)
